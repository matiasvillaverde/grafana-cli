	...
	return []discoveryCommand{
		...
		},
		{
			...
			Subcommands: []discoveryCommand{
				...
				{Name: "share", Description: "Create a Grafana short URL for a dashboard or panel share link", ReadOnly: false, Flags: []discoveryFlag{{Name: "--uid", Type: "string", Description: "Dashboard UID"}, {Name: "--slug", Type: "string", Description: "Dashboard slug"}, {Name: "--panel-id", Type: "int", Default: 0, Description: "Panel ID for solo-panel shares"}, {Name: "--from", Type: "string", Description: "Time range start"}, {Name: "--to", Type: "string", Description: "Time range end"}, {Name: "--theme", Type: "string", Description: "Theme override"}, {Name: "--org-id", Type: "int", Default: 0, Description: "Organization ID override"}}, Examples: []string{"grafana dashboards share --uid incident-overview", "grafana dashboards share --uid incident-overview --panel-id 4 --from now-6h --to now"}, OutputShape: `{"uid":"abc123","dashboard_uid":"incident-overview","share_path":"/d/incident-overview/share","url":"/goto/abc123"}`, RelatedCommands: []string{"dashboards get", "dashboards render"}, TokenCost: "small"},
				{Name: "permissions", Description: "Inspect and replace dashboard permissions", ReadOnly: false, Subcommands: []discoveryCommand{
					{Name: "get", Description: "Get permissions for one dashboard", ReadOnly: true, Flags: []discoveryFlag{{Name: "--uid", Type: "string", Description: "Dashboard UID"}}, Examples: []string{"grafana dashboards permissions get --uid incident-overview"}, OutputShape: `[{"role":"Viewer","permission":1}]`, RelatedCommands: []string{"dashboards get", "folders permissions get"}, TokenCost: "small"},
					{Name: "update", Description: "Replace dashboard permissions using a JSON items array", ReadOnly: false, Flags: []discoveryFlag{{Name: "--uid", Type: "string", Description: "Dashboard UID"}, {Name: "--items-json", Type: "json", Description: "Permissions items array"}}, Examples: []string{`grafana --yes dashboards permissions update --uid incident-overview --items-json '[{"role":"Viewer","permission":1}]'`}, OutputShape: `{"message":"dashboard permissions updated"}`, RelatedCommands: []string{"dashboards permissions get", "folders permissions update"}, TokenCost: "small"},
				}},
			},
		},
		{
		...
		},
		{
			...
			Subcommands: []discoveryCommand{
				...
				{Name: "permissions", Description: "Inspect and replace folder permissions", ReadOnly: false, Subcommands: []discoveryCommand{
					{Name: "get", Description: "Get permissions for one folder", ReadOnly: true, Flags: []discoveryFlag{{Name: "--uid", Type: "string", Description: "Folder UID"}}, Examples: []string{"grafana folders permissions get --uid ops"}, OutputShape: `[{"teamId":7,"permission":2}]`, RelatedCommands: []string{"folders get", "dashboards permissions get"}, TokenCost: "small"},
					{Name: "update", Description: "Replace folder permissions using a JSON items array", ReadOnly: false, Flags: []discoveryFlag{{Name: "--uid", Type: "string", Description: "Folder UID"}, {Name: "--items-json", Type: "json", Description: "Permissions items array"}}, Examples: []string{`grafana --yes folders permissions update --uid ops --items-json '[{"role":"Editor","permission":2}]'`}, OutputShape: `{"message":"folder permissions updated"}`, RelatedCommands: []string{"folders permissions get", "dashboards permissions update"}, TokenCost: "small"},
				}},
			},
		},
		{
